      ...
      <div className="rounded-lg border border-white/10 bg-white/5 p-6 backdrop-blur-sm">
        ...
        <div className="mt-6 rounded-lg border border-blue-500/30 bg-blue-500/5 p-4">
          <p className="text-sm text-blue-400">
            <strong>Backend Enhancement Required:</strong> To enable full user management, the backend needs
            to expose a function to list all users with their profiles and roles. Role promotion/demotion
            functionality is available via the <code className="rounded bg-black/50 px-1">assignCallerUserRole</code> backend method.
          </p>
        </div>
      </div>
    </div>
